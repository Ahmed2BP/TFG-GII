...
class OccupancyBasedReward(BaseReward):
    ...
    def __init__(
        ...
        """
        Occupancy based reward function.
        ...
        super(OccupancyBasedReward, self).__init__(env)
    ...
    def __call__(self):
        ...
        reward = weight_energy * reward_energy + \
            (1.0 - weight_energy) * reward_comfort
...
class OccupancyBasedPropReward(BaseReward):
    ...
    def __init__(
        ...
        """
        Occupancy based proportional reward function.
        ...
        super(OccupancyBasedPropReward, self).__init__(env)
